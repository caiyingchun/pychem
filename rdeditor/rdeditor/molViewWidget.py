...
class MolWidget(QtSvg.QSvgWidget):
    ...
    molChanged = QtCore.pyqtSignal(name="molChanged")
    @property
    def mol(self):
        return self._mol
    ...
    selectionChanged = QtCore.pyqtSignal(name="selectionChanged")
    ...
    sanitizeSignal = QtCore.pyqtSignal(str, name="sanitizeSignal")
    @QtCore.pyqtSlot()
    ...
    finishedDrawing = QtCore.pyqtSignal(name="finishedDrawing")
    def getMolSvg(self):
