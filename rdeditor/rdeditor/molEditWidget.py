...
class MolEditWidget(MolWidget):
    ...
    actionChanged = QtCore.pyqtSignal(name="actionChanged")
    @property
    def action(self):
        return self._action
    ...
    bondTypeChanged = QtCore.pyqtSignal(name="bondTypeChanged")
    @property
    def bondtype(self):
    ...
    atomTypeChanged = QtCore.pyqtSignal(name="atomTypeChanged")
    @property
    def atomtype(self):
